...
- README-ufr2-2.4xUS.txt (This document)
...
- cndrvcups-ufr2-us-2.40-X.i386.rpm (for 32-bit)
- cndrvcups-ufr2-us-2.40-X.x86_64.rpm (for 64-bit)
- cndrvcups-ufr2-us_2.40-X_i386.deb (for Debian 32-bit)
...
Supported Printer: imageRUNNER 1023
...
- If you attempt to print from a Color imageRUNNER/LBP printer using this driver
  in a 64-bit version of Fedora 9, Fedora 10, Fedora 11, Fedora 12, Fedora 13,
...
- If you are using the Color imageRUNNER C1022/C1022i, MF8400 Series, or 
  MF9100 Series, although IPv6 can be set from the control panel of the printer,
